    ...
    volter.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let nyoutube = ('© Volter\nYoutube/Sc :\nhttps://youtube.com/c/Volterdev')
                let jumhal = '100000000000000'
                if (anu.action == 'add') {
                    volter.sendMessage(anu.id, { image: { url: ppuser }, fileLength: jumhal, contextInfo: { mentionedJid: [num] }, caption: `Welcome To ${metadata.subject} @${num.split("@")[0]}`, buttons: buttons, footer: nyoutube})
